...
for i in range(num_loans):
    ...
    # Calculate Break-Even Default (EL / Loan Amount)
    break_even_default = EL / amount  # Break-even default calculation
    ...
    records.append([
        ...
        interest_rate_change, unemployment_rate_change, EAD, LGD, PD, EL, UL, break_even_default
    ])
...
columns = [
    ...
    "Interest Rate Change", "Unemployment Rate Change", "EAD", "LGD", "PD", "EL", "UL", "Break-Even Default"
]

df = pd.DataFrame(records, columns=columns)
df.to_excel("aligned_risk_personal_loans_with_break_even.xlsx", index=False)
print("✅ Excel file 'aligned_risk_personal_loans_with_break_even.xlsx' generated.")
